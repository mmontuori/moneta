...
"""Verify that starting moneta with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start moneta with -h for help text")
        ...
        self.log.info("Start moneta with -version for version information")
        ...
        self.log.info("Start monetad with -fakearg to make sure it does not start")
