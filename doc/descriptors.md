# Support for Output Descriptors in Moneta Core

Since Moneta Core v0.17, there is support for Output Descriptors. This is a
...
on Moneta's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Moneta Core wallets, a convenience function `combo` is
