...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S(MONETA_MAIN_GENESIS_HASH); //1683528
...
public:
    CTestNetParams() {
        strNetworkID = "test";
        consensus.nSubsidyHalvingInterval = 840000;
        consensus.BIP16Height = MONETA_TEST_BIP16HEIGHT; // always enforce P2SH BIP16 on testnet
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S(MONETA_TEST_GENESIS_HASH); //1174621
        ...
        // vSeeds.emplace_back("seed-b.moneta.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.BIP16Height = MONETA_REGTEST_BIP16HEIGHT;
        consensus.BIP34Height = MONETA_REGTEST_BIP34HEIGHT; // BIP34 activated on regtest (Used in functional tests)
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = MONETA_REGTEST_BIP65HEIGHT; // BIP65 activated on regtest (Used in functional tests)
        consensus.BIP66Height = MONETA_REGTEST_BIP66HEIGHT; // BIP66 activated on regtest (Used in functional tests)
