...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " moneta-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  moneta-tx [options] <hex-tx> [commands]  Update hex-encoded moneta transaction\n" +
            "or:     moneta-tx [options] -create [commands]   Create hex-encoded moneta transaction\n" +
            "\n";
